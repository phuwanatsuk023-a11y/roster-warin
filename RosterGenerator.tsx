          ...
          <div className="mb-4 font-sarabun text-black leading-relaxed">
            {gender === 'F' ? (
              ...
              <>
                ...
                <div className="text-justify indent-8 leading-snug" style={{ fontSize: `${titleFontSize}pt` }}>
                  ข้อ 2 เจ้าหน้าที่อยู่เวรและผู้ตรวจเวร ประจำสำนักงานเทศบาลเมืองวารินชำราบ สำนักงานโครงการปรับปรุงคุณภาพน้ำ ศูนย์บริการสาธารณสุข แห่งที่ 2 และแห่งที่ 3 (กลางคืน) ซึ่งเริ่มปฏิบัติหน้าที่ ตั้งแต่เวลา 18.00 - 06.00 น.ของวันรุ่งขึ้น ไม่เว้นวันหยุดราชการ ประกอบด้วยบุคคลดังต่อไปนี้
                </div>
              </>
            )}
          </div>
